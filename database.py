...
# Get database connection string - check Streamlit secrets first, then environment
try:
    ...
    if not DATABASE_URL:
        raise EnvironmentError("DATABASE_URL not found. Please set it in your Streamlit secrets or .env file.")
